...
window.SwaggerTranslator.learn({
  ...
  "Show Swagger Petstore Example Apis":
    "Mostrar Api Ejemplo de Swagger Petstore",
  "Can't read from server.  It may not have the appropriate access-control-origin settings.":
    "No se puede leer del servidor. Tal vez no tiene la configuración de control de acceso de origen (access-control-origin) apropiado.",
  ...
  "Finished Loading Resource Information. Rendering Swagger UI":
    "Finalizada la carga del recurso de Información. Mostrando Swagger UI",
