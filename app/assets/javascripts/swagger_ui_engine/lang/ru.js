...
window.SwaggerTranslator.learn({
  ...
  "Click to set as parameter value":
    "Нажмите, чтобы испльзовать в качестве значения параметра",
  apply: "применить",
  ...
  "Can't read from server. It may not have the appropriate access-control-origin settings.":
    "Не удается получить ответ от сервера. Возможно, проблема с настройками доступа",
  ...
  "Finished Loading Resource Information. Rendering Swagger UI":
    "Загрузка информации о ресурсах завершена. Рендерим",
