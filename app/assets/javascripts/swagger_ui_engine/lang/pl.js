...
window.SwaggerTranslator.learn({
  ...
  "can't parse JSON.  Raw result":
    "nie można przetworzyć pliku JSON.  Nieprzetworzone dane",
  ...
  "Show Swagger Petstore Example Apis":
    "Pokaż Przykładowe Api Swagger Petstore",
  "Can't read from server.  It may not have the appropriate access-control-origin settings.":
    "Brak połączenia z serwerem. Może on nie mieć odpowiednich ustawień access-control-origin.",
  ...
  "Finished Loading Resource Information. Rendering Swagger UI":
    "Ukończono Ładowanie Informacji o Zasobie. Renderowanie Swagger UI",
