...
window.SwaggerTranslator.learn({
  ...
  "can't parse JSON.  Raw result":
    "non è possibile parsare il JSON. Risultato grezzo (raw).",
  ...
  "Show Swagger Petstore Example Apis":
    "Mostra le api di esempio di Swagger Petstore",
  "Can't read from server.  It may not have the appropriate access-control-origin settings.":
    "Non è possibile leggere dal server. Potrebbe non avere le impostazioni di controllo accesso origine (access-control-origin) appropriate.",
  "Please specify the protocol for":
    "Si prega di specificare il protocollo per",
  ...
  "Finished Loading Resource Information. Rendering Swagger UI":
    "Lettura informazioni risorse termianta. Swagger UI viene mostrata",
