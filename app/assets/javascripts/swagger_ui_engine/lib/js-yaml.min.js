  ...
  })(
    {
      ...
      3: [
        function (t, e, n) {
          ...
          function r(t) {
            var e, n, i;
            if (((e = t.toString(16).toUpperCase()), 255 >= t))
              (n = "x"), (i = 2);
            else if (65535 >= t) (n = "u"), (i = 4);
            else {
              if (!(4294967295 >= t))
                throw new O(
          ...
          function l(t, e, n, i) {
            var r, o, s, l, f, m, y, g, v, x, A, b, w, k, C, j, O, S, _, I, E;
            if (0 === e.length) return void (t.dump = "''");
            if (-1 !== et.indexOf(e)) return void (t.dump = "'" + e + "'");
            for (
              r = !0,
              ...
              if (
                ...
                if (((t.tag = n ? s.tag : "?"), s.represent)) {
                  if (
                    ...
                    "[object Function]" === I.call(s.represent))
                  )
                    i = s.represent(e, c);
                  else {
          ...
          function A(t, e, n, i, r, o) {
            ...
            var a = I.call(t.dump);
            i && (i = 0 > t.flowLevel || t.flowLevel > e);
            var s,
              c,
              u = "[object Object]" === a || "[object Array]" === a;
            if (
              (u && ((s = t.duplicates.indexOf(n)), (c = -1 !== s)),
              ((null !== t.tag && "?" !== t.tag) ||
                c ||
                (2 !== t.indent && e > 0)) &&
                (r = !1),
          ...
          (u.prototype.takeUpTo = function (t) {
            ...
            if (t < this.checkpoint)
              throw (
                ((e = new Error("position should be > checkpoint")),
                (e.position = t),
      ...
      5: [
        function (t, e, n) {
          ...
          function b(t) {
            ...
            return (
              ...
              !(
                ...
                ((n += 3), (e = t.input.charCodeAt(n)), 0 !== e && !o(e))
              )
            );
          }
          function w(t, e) {
          ...
          function j(t, e) {
            var n, r, o, a, u, l;
            if (((l = t.input.charCodeAt(t.position)), 34 !== l)) return !1;
            for (
              t.kind = "scalar",
                t.result = "",
                t.position++,
              ...
              if (34 === l) return y(t, n, t.position, !0), t.position++, !0;
              if (92 === l) {
                if (
                  (y(t, n, t.position, !0),
                  ...
                  A(t, !1, e);
                else if (256 > l && rt[l]) (t.result += ot[l]), t.position++;
                else if ((u = c(l)) > 0) {
                  for (o = u, a = 0; o > 0; o--)
                    (l = t.input.charCodeAt(++t.position)),
                      (u = s(l)) >= 0
          ...
          function O(t, e) {
            var n,
              ...
              y = t.tag,
              g = t.anchor;
            if (((h = t.input.charCodeAt(t.position)), 91 === h))
              (a = 93), (u = !1), (i = []);
            else {
              if (123 !== h) return !1;
              (a = 125), (u = !0), (i = {});
          ...
          function S(t, e) {
            var n,
              ...
              f = 0,
              h = !1;
            if (((s = t.input.charCodeAt(t.position)), 124 === s)) o = !1;
            else {
              if (62 !== s) return !1;
              o = !0;
            }
            for (t.kind = "scalar", t.result = ""; 0 !== s; )
              if (
                ((s = t.input.charCodeAt(++t.position)), 43 === s || 45 === s)
              )
                z === c
                  ? (c = 43 === s ? Q : J)
          ...
          function E(t) {
            var e,
              ...
              a = !1,
              s = !1;
            if (((r = t.input.charCodeAt(t.position)), 33 !== r)) return !1;
            if (
              (null !== t.tag && d(t, "duplication of a tag property"),
              (r = t.input.charCodeAt(++t.position)),
              60 === r
          ...
          function F(t) {
            ...
            for (
              null !== t.anchor && d(t, "duplication of an anchor property"),
                n = t.input.charCodeAt(++t.position),
                e = t.position;
              0 !== n && !o(n) && !a(n);
          ...
          function N(t) {
            var e, n, i;
            if (((i = t.input.charCodeAt(t.position)), 42 !== i)) return !1;
            for (
          ...
          function T(t, e, n, i, r) {
            ...
            return null !== t.tag || null !== t.anchor || y;
          }
          function M(t) {
            var e,
              n,
          ...
          var st = {
            YAML: function (t, e, n) {
              ...
              null !== t.version && d(t, "duplication of %YAML directive"),
                ...
                (i = /^([0-9]+)\.([0-9]+)$/.exec(n[0])),
                null === i && d(t, "ill-formed argument of the YAML directive"),
                (r = parseInt(i[1], 10)),
                (o = parseInt(i[2], 10)),
                1 !== r && d(t, "unacceptable YAML version of the document"),
                (t.version = n[0]),
                (t.checkLineBreaks = 2 > o),
                1 !== o &&
                  2 !== o &&
        ...
        function (t, e, n) {
          ...
          function i(t) {
            ...
            for (e = 0, n = u.length; n > e; e += 1) {
              if (((i = u[e]), (o = !1), "[object Object]" !== s.call(i)))
                return !1;
              for (r in i)
                if (a.call(i, r)) {
                  if (o) return !1;
        ...
        function (t, e, n) {
          ...
          function i(t) {
            ...
            for (o = new Array(s.length), e = 0, n = s.length; n > e; e += 1) {
              if (((i = s[e]), "[object Object]" !== a.call(i))) return !1;
      ...
      27: [
        function (t, e, n) {
          ...
          function i(t) {
            ...
            var e,
              n = t;
            for (e in n) if (a.call(n, e) && null !== n[e]) return !1;
            return !0;
          }
          function r(t) {
            return null !== t ? t : {};
        ...
        function (e, n, i) {
          !(function (e) {
            ...
            var c = function () {}.toString().indexOf("_") > -1,
              ...
              v = !0,
              x = { toString: "" };
            for (var A in x) x.hasOwnProperty(A) && (v = !1);
            ...
            var w = !0;
            "object" == typeof i && ((n.exports = s), (w = !1)),
