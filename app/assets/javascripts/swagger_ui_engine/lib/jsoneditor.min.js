!(function () {
  ...
  var e = function (t) {
    ...
    s = function (t, e) {
      if (t && "object" == typeof t) {
        ...
        if (
          Array.isArray(t) ||
          ("number" == typeof t.length && t.length > 0 && t.length - 1 in t)
        ) {
  ...
  (n.prototype = {
    ...
    init: function () {
      ...
      i && (this.iconlib = new i()),
        ...
        this._loadExternalRefs(this.schema, function () {
          ...
          var e = t.getEditorClass(t.schema);
    ...
    trigger: function (t) {
      if (this.callbacks && this.callbacks[t] && this.callbacks[t].length)
        for (var e = 0; e < this.callbacks[t].length; e++)
          this.callbacks[t][e]();
      return this;
    },
        ...
        if (t.hasOwnProperty(s))
          if (t[s] && "object" == typeof t[s] && Array.isArray(t[s]))
            for (var r = 0; r < t[s].length; r++)
              "object" == typeof t[s][r] && i(this._getExternalRefs(t[s][r]));
          else
            t[s] && "object" == typeof t[s] && i(this._getExternalRefs(t[s]));
      return e;
    },
            ...
            (s.onreadystatechange = function () {
              if (4 == s.readyState) {
                ...
                try {
                  ...
                  throw (
                    (window.console.log(h), "Failed to parse external ref " + t)
                  );
                }
      ...
      return (
        s(t, function (t, i) {
          "undefined" != typeof e[t]
            ? "required" === t && "object" == typeof i && Array.isArray(i)
      ...
      _validateSchema: function (t, e, r) {
        ...
        if (t.oneOf) {
          ...
          for (a = 0; a < t.oneOf.length; a++) {
            var c = this._validateSchema(t.oneOf[a], e, r);
        ...
        if ("number" == typeof e)
            ...
            t.minLength &&
              ...
              d.push({
                ...
                message: this.translate(
                  1 === t.minLength ? "error_notempty" : "error_minLength",
                  [t.minLength]
                ),
              }),
            t.pattern &&
          ...
          if (t.required && Array.isArray(t.required))
            for (a = 0; a < t.required.length; a++)
              "undefined" == typeof e[t.required[a]] &&
                d.push({
                  path: r,
                  property: "required",
          ...
          if (
            ("undefined" != typeof t.additionalProperties ||
              ...
              if (
                ...
                if (Array.isArray(t.dependencies[a]))
                  for (h = 0; h < t.dependencies[a].length; h++)
                    "undefined" == typeof e[t.dependencies[a][h]] &&
                      d.push({
                        path: r,
    ...
    (n.AbstractEditor = t.extend({
      ...
      getLink: function (t) {
        var e,
          i,
          s = t.mediaType || "application/javascript",
          r = s.split("/")[0],
      ...
      onWatchedFieldChange: function () {
        ...
        if (this.link_watchers.length) {
          ...
          for (var s = 0; s < this.link_watchers.length; s++)
        ...
        if (
          (this.options.compact ||
            (this.header = this.label =
              this.theme.getFormInputLabel(this.getTitle(), this.isRequired())),
        ...
        if (this.row_container) {
          ...
          if ("grid" === this.format) {
            ...
            for (
              ...
              var h = this.theme.getGridRow();
              for (r.appendChild(h), e = 0; e < n[t].editors.length; e++) {
                var l = n[t].editors[e].key,
                  d = this.editors[l];
                d.options.hidden
      ...
      preBuild: function () {
        ...
        if (
          ...
          s(this.schema.properties, function (e, i) {
            ...
            var r = t.editors[e].options.hidden
              ? 0
      ...
      build: function () {
        ...
        if (this.options.table_row)
          ...
          (e.style.clear = "both"),
            ...
            this.schema.options &&
            "undefined" != typeof this.schema.options.disable_edit_json
        ...
        for (t in this.cached_editors)
          this.cached_editors.hasOwnProperty(t) &&
            ...
            s <= this.schema.minProperties
              ? ((this.addproperty_checkboxes[t].disabled =
                  this.addproperty_checkboxes[t].checked),
    ...
    (n.defaults.editors.array = n.AbstractEditor.extend({
      ...
      getItemInfo: function (t) {
        ...
        return "undefined" != typeof this.item_info[i]
          ? this.item_info[i]
      ...
      getElementEditor: function (t) {
        ...
        (i = this.jsoneditor.expandRefs(i)),
          (i.title = e.title + " " + (t + 1));
        var s,
          r = this.jsoneditor.getEditorClass(i);
        (s = this.tabs_holder
      ...
      setValue: function (t, e) {
        ...
        if (i !== this.serialized) {
          ...
          for (var n = t.length; n < r.rows.length; n++)
    ...
    (n.defaults.editors.table = n.defaults.editors.array.extend({
      ...
      refreshRowButtons: function () {
        ...
        var r = !1;
        this.value.length
          ? 1 === this.value.length || this.hide_delete_buttons
        ...
        return (
          ...
          t.selected < 0
            ...
            : ((this.switcher.value = this.select_options[this.selected]),
              void (this.display_area.innerHTML =
    ...
    (n.defaults.editors.select = n.AbstractEditor.extend({
      setValue: function (t, e) {
        ...
        this.enum_values.indexOf(i) < 0 && (i = this.enum_values[0]),
          this.value !== i &&
            ((this.input.value =
              this.enum_options[this.enum_values.indexOf(i)]),
        ...
        if (
          ...
          if (
            ...
            for (a = 0; a < this.schema.enumSource.length; a++)
              "string" == typeof this.schema.enumSource[a]
      ...
      onInputChange: function () {
        var t = this.input.value,
          e = t;
        -1 === this.enum_options.indexOf(t) && (e = this.enum_options[0]),
    ...
    (n.defaults.editors.multiselect = n.AbstractEditor.extend({
      ...
      build: function () {
        ...
        if (
          ...
          for (
            ...
            var i = this.theme.getCheckboxLabel(this.option_keys[t]);
      ...
      setValue: function (t, e) {
        ...
        for (
          t = t || [],
            "object" != typeof t ? (t = [t]) : Array.isArray(t) || (t = []),
            i = 0;
          i < t.length;
          i++
        )
        ...
        for (i in this.select_options)
          this.select_options.hasOwnProperty(i) &&
            (this.select_options[i][
              "select" === this.input_type ? "selected" : "checked"
            ] = -1 !== t.indexOf(i));
      ...
      getNumColumns: function () {
        ...
        for (var e in this.select_values)
      ...
      build: function () {
        ...
        this.options.compact ||
          (this.label = this.header =
            this.theme.getCheckboxLabel(this.getTitle())),
          this.schema.description &&
            (this.description = this.theme.getFormInputDescription(
              this.schema.description
            )),
  ...
  (n.AbstractTheme = t.extend({
    ...
    getHeader: function (t, e) {
      var i = document.createElement("h3");
      return (
        "string" == typeof t ? (i.textContent = t) : i.appendChild(t),
    ...
    (n.defaults.themes.bootstrap2 = n.AbstractTheme.extend({
      ...
      getFormControl: function (t, e, i) {
        ...
        return (
          ...
          t && "checkbox" === e.getAttribute("type")
            ? (s.appendChild(r),
    ...
    (n.defaults.themes.foundation = n.AbstractTheme.extend({
      ...
      getFormInputField: function (t) {
        ...
        return (
          (e.style.width = "100%"),
          (e.style.marginBottom = "checkbox" === t ? "0" : "12px"),
          e
        );
      },
      getFormInputDescription: function (t) {
  ...
  n.defaults.resolvers.unshift(function (t) {
    ...
    n.defaults.resolvers.unshift(function (t) {
      return "boolean" === t.type
        ? "checkbox" === t.format || (t.options && t.options.checkbox)
          ? "checkbox"
          : "select"
        : void 0;
    }),
