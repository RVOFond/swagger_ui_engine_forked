!(function (e, t) {
  ...
  function v(e, t) {
    for (var n, r, i = [], o = 0, a = e.length; o < a; o++)
      (n = e[o]),
        n.style &&
          ((i[o] = K._data(n, "olddisplay")),
          t
            ? (!i[o] && "none" === n.style.display && (n.style.display = ""),
              "" === n.style.display &&
                y(n) &&
                (i[o] = K._data(n, "olddisplay", T(n.nodeName))))
            : ((r = nt(n, "display")),
  ...
  function x(e, t, n, r) {
    for (
      ...
      "margin" === n && (o += K.css(e, n + gt[i], !0)),
        r
          ? ("content" === n &&
              (o -= parseFloat(nt(e, "padding" + gt[i])) || 0),
            "margin" !== n &&
              (o -= parseFloat(nt(e, "border" + gt[i] + "Width")) || 0))
          : ((o += parseFloat(nt(e, "padding" + gt[i])) || 0),
            "padding" !== n &&
              (o += parseFloat(nt(e, "border" + gt[i] + "Width")) || 0));
    return o;
  ...
  function w(e, t, n) {
    ...
    if (r <= 0) {
      if (
        ((r = nt(e, t)), (r < 0 || null == r) && (r = e.style[t]), ct.test(r))
      )
        return r;
  ...
  function T(e) {
    ...
    return (
      t.remove(),
      ("none" !== n && "" !== n) ||
        ((rt = R.body.appendChild(
          rt ||
            K.extend(R.createElement("iframe"), {
              frameBorder: 0,
              width: 0,
              height: 0,
            })
  ...
  function E(e, n, r, i, o, a) {
    ...
    for (
      var s, l = e[o], u = 0, c = l ? l.length : 0, f = e === Ot;
      u < c && (f || !s);
      u++
    )
      (s = l[u](n, r, i)),
        "string" == typeof s &&
          (!f || a[s]
            ? (s = t)
            : (n.dataTypes.unshift(s), (s = E(e, n, r, i, s, a))));
  ...
  function H(e, t) {
    K.each(t, function (t, n) {
      for (
        var r = (Kt[t] || []).concat(Kt["*"]), i = 0, o = r.length;
        i < o;
        i++
      )
  ...
  function F(e, t, n) {
    ...
    for (M(u, l.opts.specialEasing); i < o; i++)
      if ((r = Qt[i].call(l, e, u, l.opts))) return r;
    return (
      H(l, u),
      K.isFunction(l.opts.start) && l.opts.start.call(e, l),
      K.fx.timer(K.extend(s, { anim: l, queue: l.opts.queue, elem: e })),
      l
  ...
  function q(e, t) {
    for (var n, r = { height: e }, i = 0; i < 4; i += 2 - t)
  ...
  var W,
    ...
    ee = /\S/,
    te = /\s+/,
    ne = ee.test(" ") ? /^[\s\xA0]+|[\s\xA0]+$/g : /^\s+|\s+$/g,
    re = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,
    ie = /^<(\w+)\s*\/?>(?:<\/\1>|)$/,
    oe = /^[\],:{}\s]*$/,
    ae = /(?:^|:|,)(?:\s*\[)+/g,
    ...
    pe = function () {
      R.addEventListener
        ? (R.removeEventListener("DOMContentLoaded", pe, !1), K.ready())
        : "complete" === R.readyState &&
          (R.detachEvent("onreadystatechange", pe), K.ready());
    },
    de = {};
  (K.fn = K.prototype =
    {
          ...
          if (null != (e = arguments[l]))
            for (n in e)
              (r = s[n]),
                (i = e[n]),
                s !== i &&
                  (c && i && (K.isPlainObject(i) || (o = K.isArray(i)))
                    ? (o
                        ? ((o = !1), (a = r && K.isArray(r) ? r : []))
                        : (a = r && K.isPlainObject(r) ? r : {}),
                      (s[n] = K.extend(c, a, i)))
                    : i !== t && (s[n] = i));
        return s;
      }),
      ...
      parseJSON: function (t) {
        return t && "string" == typeof t
          ? ((t = K.trim(t)),
            e.JSON && e.JSON.parse
              ? e.JSON.parse(t)
              : oe.test(t.replace(se, "@").replace(le, "]").replace(ae, ""))
    ...
    (K.ready.promise = function (t) {
      if (!P)
        if (
          ((P = K.Deferred()),
          "complete" === R.readyState ||
            ("loading" !== R.readyState && R.addEventListener))
        )
  ...
  (K.Callbacks = function (e) {
    ...
    var r,
      ...
      f = function (t) {
        for (
          r = e.memory && t, i = !0, l = a || 0, a = 0, s = u.length, o = !0;
          u && l < s;
          l++
        )
          ...
          if (u) {
            ...
            !(function n(t) {
              K.each(t, function (t, r) {
                !K.isFunction(r) || (e.unique && p.has(r))
                  ? r && r.length && n(r)
                  : u.push(r);
              });
            })(arguments),
    ...
    data: function (e, n, r, i) {
      if (K.acceptData(e)) {
        ...
        if ((f && c[f] && (i || c[f].data)) || !l || r !== t)
          return (
            f || (u ? (e[s] = f = K.deletedIds.pop() || ++K.uuid) : (f = s)),
            c[f] || ((c[f] = {}), u || (c[f].toJSON = K.noop)),
            ("object" != typeof n && "function" != typeof n) ||
              (i
                ? (c[f] = K.extend(c[f], n))
                : (c[f].data = K.extend(c[f].data, n))),
            (o = c[f]),
    ...
    K.fn.extend({
      data: function (e, n) {
        ...
        if (e === t) {
          if (
            this.length &&
            ((f = K.data(u)), 1 === u.nodeType && !K._data(u, "parsedAttrs"))
          ) {
            for (a = u.attributes, l = a.length; c < l; c++)
              (s = a[c].name),
                0 === s.indexOf("data-") &&
                  ((s = K.camelCase(s.substring(5))), r(u, s, f[s]));
  ...
  K.fn.extend({
    ...
    toggleClass: function (e, t) {
      ...
      return K.isFunction(e)
        ...
        : this.each(function () {
            if ("string" === n)
              for (
                var i, o = 0, a = K(this), s = t, l = e.split(te);
                (i = l[o++]);
    ...
    hasClass: function (e) {
      for (var t = " " + e + " ", n = 0, r = this.length; n < r; n++)
        if (
          1 === this[n].nodeType &&
          (" " + this[n].className + " ").replace(xe, " ").indexOf(t) > -1
        )
          return !0;
      return !1;
    },
    val: function (e) {
        ...
        o = this[0];
      {
        ...
        if (o)
          return (
            (n = K.valHooks[o.type] || K.valHooks[o.nodeName.toLowerCase()]),
        ...
        if (e && 3 !== l && 8 !== l && 2 !== l)
          return i && K.isFunction(K.fn[n])
            ...
            : ((s = 1 !== l || !K.isXMLDoc(e)),
              s &&
                ((n = n.toLowerCase()),
                (a = K.attrHooks[n] || (Ee.test(n) ? ve : ye))),
              r !== t
                ? null === r
        ...
        tabIndex: {
          get: function (e) {
            ...
            return n && n.specified
              ? parseInt(n.value, 10)
              : Ne.test(e.nodeName) || (Ce.test(e.nodeName) && e.href)
              ? 0
              : t;
          },
        },
      ...
      (ye = K.valHooks.button =
        {
          ...
          set: function (e, t, n) {
            ...
            return (
              r || ((r = R.createAttribute(n)), e.setAttributeNode(r)),
              (r.value = t + "")
            );
          },
        }),
  ...
  (K.event = {
        ...
        for (
              ...
              ((a.handle = s =
                function (e) {
                  return "undefined" == typeof K ||
                    ...
                    ? t
                    : K.event.dispatch.apply(s.elem, arguments);
                }),
              (s.elem = e)),
            n = K.trim(Fe(n)).split(" "),
            u = 0;
          ...
          (c = Ae.exec(n[u]) || []),
            ...
            g ||
              ((g = l[f] = []),
              (g.delegateCount = 0),
              (m.setup && m.setup.call(e, i, p, s) !== !1) ||
                (e.addEventListener
      ...
      if (m && (p = m.events)) {
        for (t = K.trim(Fe(t || "")).split(" "), o = 0; o < t.length; o++)
          if (((a = Ae.exec(t[o]) || []), (s = l = a[1]), (u = a[2]), s)) {
            ...
            0 === h.length &&
              c !== h.length &&
              ((!d.teardown || d.teardown.call(e, u, m.handle) === !1) &&
                K.removeEvent(e, s, m.handle),
              delete p[s]);
      ...
      if (!i || (3 !== i.nodeType && 8 !== i.nodeType)) {
        ...
        if (
          ...
          for (l in a)
            a[l].events &&
              a[l].events[m] &&
              K.event.trigger(n, r, a[l].handle.elem, !0);
          return;
        }
        if (
          ((n.result = t),
          ...
          return;
        if (
          ((h = [[i, p.bindType || m]]), !o && !p.noBubble && !K.isWindow(i))
        ) {
          for (
            g = p.delegateType || m,
        ...
        for (l = 0; l < h.length && !n.isPropagationStopped(); l++)
          (u = h[l][0]),
            ...
            d && d.apply(u, r),
            (d = f && u[f]),
            d && K.acceptData(u) && d.apply(u, r) === !1 && n.preventDefault();
        return (
          (n.type = m),
          !o &&
    ...
    dispatch: function (n) {
      ...
      if (
        ...
        !y.preDispatch || y.preDispatch.call(this, n) !== !1)
      ) {
        if (h && (!n.button || "click" !== n.type))
          for (
            a = K(this), a.context = this, o = n.target;
            o != this;
            o = o.parentNode || this
          )
            if (o.disabled !== !0 || "click" !== n.type) {
              for (l = {}, c = [], a[0] = o, r = 0; r < h; r++)
                (f = d[r]),
                  (p = f.selector),
                  l[p] === t && (l[p] = a.is(p)),
                  l[p] && c.push(f);
        ...
        for (
          d.length > h && v.push({ elem: this, matches: d.slice(h) }), r = 0;
          r < v.length && !n.isPropagationStopped();
          r++
        )
          for (
            u = v[r], n.currentTarget = u.elem, i = 0;
            i < u.matches.length && !n.isImmediatePropagationStopped();
            i++
          )
            (f = u.matches[i]),
              (m ||
    ...
    fix: function (e) {
      ...
      return (
        e.target || (e.target = r.srcElement || R),
    ...
    (function (e, t) {
      function n(e, t, n, r) {
        for (var i = 0, o = t.length; i < o; i++) oe(e, t[i], n, r);
      }
      function r(e, t, r, i, o, a) {
        var s,
          l = ae.setFilters[t.toLowerCase()];
        return (
          l || oe.error(t),
          (e || !(s = o)) && n(e || "*", i, (s = []), o),
          s.length > 0 ? l(s, r, a) : []
      ...
      function i(e, i, o, a, s) {
        for (
          ...
          for (v.exec(""), e = s[m], f = [], c = 0, p = a; (l = v.exec(e)); )
            (g = v.lastIndex = l.index + l[0].length),
              g > c &&
                ((h = e.slice(c, l.index)),
                (c = g),
                (d = [i]),
                M.test(h) && (p && (d = p), (p = a)),
                (u = P.test(h)) && (h = h.slice(0, -5).replace(M, "$&*")),
                l.length > 1 && l[0].replace(b, x),
                (p = r(h, l[1], l[2], d, p, u)));
          p
            ? ((f = f.concat(p)),
              (h = e.slice(c)) && ")" !== h
                ? M.test(h)
                  ? n(h, f, o, a)
                  : oe(h, i, o, a ? a.concat(p) : p)
                : T.apply(o, f))
            : oe(e, i, o, a);
        }
        return 1 === y ? o : oe.uniqueSort(o);
      }
      function o(e, t, n) {
        for (
          var r,
          ...
          for (a.push((r = [])), d && (i = " " + i); i; ) {
            (u = !1),
              (l = M.exec(i)) &&
                ...
                (u = r.push({ part: l.pop().replace(F, " "), captures: l })));
            for (o in p)
              (l = z[o].exec(i)) &&
                (!f[o] || (l = f[o](l, t, n))) &&
                ((i = i.slice(l.shift().length)),
                (u = r.push({ part: o, captures: l })));
            if (!u) break;
          }
        return u || oe.error(e), a;
      }
      function a(e, t, n) {
        var r = t.dir,
          i = x++;
        return (
          ...
          t.first
            ? function (t, n) {
                for (; (t = t[r]); ) if (1 === t.nodeType) return e(t, n) && t;
              }
            : function (t, n) {
                for (var o, a = i + "." + f, s = a + "." + c; (t = t[r]); )
                  if (1 === t.nodeType) {
                    if ((o = t[N]) === s) return t.sizset;
                    if ("string" == typeof o && 0 === o.indexOf(a)) {
                      if (t.sizset) return t;
                    } else {
                      if (((t[N] = s), e(t, n))) return (t.sizset = !0), t;
                      t.sizset = !1;
                    }
                  }
              }
      ...
      function l(e, t, n) {
        for (var r, i, o = 0; (r = e[o]); o++)
          ae.relative[r.part]
            ? (i = a(i, ae.relative[r.part], t))
            : (r.captures.push(t, n),
              (i = s(i, ae.filter[r.part].apply(null, r.captures))));
        return i;
      }
      function u(e) {
        return function (t, n) {
          for (var r, i = 0; (r = e[i]); i++) if (r(t, n)) return !0;
          return !1;
        };
      }
      var c,
        ...
        te = Z(function (e) {
          (e.id = N + 0),
            (e.innerHTML =
              "<a name='" + N + "'></a><div name='" + N + "'></div>"),
            m.insertBefore(e, m.firstChild);
          var t =
            g.getElementsByName &&
            g.getElementsByName(N).length ===
              2 + g.getElementsByName(N + 0).length;
          return (h = !g.getElementById(N)), m.removeChild(e), t;
        }),
        ne = Z(function (e) {
          return (
        ...
        re = Z(function (e) {
          return (
            ...
            e.firstChild &&
              typeof e.firstChild.getAttribute !== y &&
        ...
        oe = function (e, t, n, r) {
          ...
          if (((a = le(t)), !a && !r && (i = B.exec(e))))
            if ((s = i[1])) {
              ...
              if (i[2])
                return T.apply(n, w.call(t.getElementsByTagName(e), 0)), n;
              if ((s = i[3]) && ie && t.getElementsByClassName)
                return T.apply(n, w.call(t.getElementsByClassName(s), 0)), n;
            }
          return pe(e, t, n, r, a);
        },
        ae = (oe.selectors = {
          ...
          filter: {
              ...
              return (
                t ||
                  ((t = X[e] =
                    new RegExp("(^|" + C + ")" + e + "(" + C + "|$)")),
                  U.push(e),
                  U.length > ae.cacheLength && delete X[U.shift()]),
                function (e) {
                  return t.test(
                    e.className ||
              ...
              if ("nth" === e) {
                ...
                return function (e) {
                  var t,
                    ...
                    s = e;
                  if (1 === n && 0 === r) return !0;
                  if (((t = e.parentNode), t && (t[N] !== i || !e.sizset))) {
                    for (
                      s = t.firstChild;
                      s && (1 !== s.nodeType || ((s.sizset = ++a), s !== e));
                      s = s.nextSibling
                    );
                    t[N] = i;
                  }
            ...
            PSEUDO: function (e, t, n, r) {
              var i = ae.pseudos[e] || ae.pseudos[e.toLowerCase()];
              return (
                i || oe.error("unsupported pseudo: " + e),
      ...
      (ae.setFilters.nth = ae.setFilters.eq),
        (ae.filters = ae.pseudos),
        re ||
          (ae.attrHandle = {
            href: function (e) {
        ...
        te &&
          (ae.order.push("NAME"),
          (ae.find.NAME = function (e, t) {
            if (typeof t.getElementsByName !== y) return t.getElementsByName(e);
          })),
        ie &&
          (ae.order.splice(1, 0, "CLASS"),
          (ae.find.CLASS = function (e, t, n) {
            if (typeof t.getElementsByClassName !== y && !n)
      ...
      var le = (oe.isXML = function (e) {
        ...
        ue = (oe.contains = m.compareDocumentPosition
          ? function (e, t) {
      ...
      var fe = (oe.compile = function (e, t, n) {
        var r,
          i,
          a,
          s = Y[e];
        ...
        return (
          ...
          (s.runs = s.dirruns = 0),
          J.push(e),
          J.length > ae.cacheLength && delete Y[J.shift()],
          s
        );
      });
      ...
      var pe = function (e, t, n, r, o) {
        ...
        if (r) a = w.call(r, 0);
          ...
          if (v.length > 1 && 9 === b && !o && (y = z.ID.exec(v[0]))) {
            if (((t = ae.find.ID(y[1], t, o)[0]), !t)) return n;
            e = e.slice(v.shift().length);
          }
          for (
            g = ((y = W.exec(v[0])) && !y.index && t.parentNode) || t,
              m = v.pop(),
              d = m.split(":not")[0],
              l = 0,
              u = ae.order.length;
            ...
            if (((h = ae.order[l]), (y = z[h].exec(d)))) {
              if (
                ((a = ae.find[h]((y[1] || "").replace(I, ""), g, o)), null == a)
              )
                continue;
              d === m &&
                ((e = e.slice(0, e.length - m.length) + d.replace(z[h], "")),
                e || T.apply(n, w.call(a, 0)));
              break;
            }
        }
        if (e)
          for (
            s = fe(e, t, o),
              f = s.dirruns++,
              null == a &&
                (a = ae.find.TAG("*", (W.test(e) && t.parentNode) || t)),
              l = 0;
            (p = a[l]);
            l++
          )
            (c = s.runs++), s(p, t) && n.push(p);
        return n;
      };
      g.querySelectorAll &&
        (function () {
  ...
  K.fn.extend({
    ...
    closest: function (e, t) {
      for (
        var n,
          ...
          i = this.length,
          o = [],
          a = qe.test(e) || "string" != typeof e ? K(e, t || this.context) : 0;
        r < i;
        r++
      )
        for (
      ...
      return (
        (o = o.length > 1 ? K.unique(o) : o), this.pushStack(o, "closest", e)
      );
    },
    index: function (e) {
      return e
    ...
    K.extend({
      ...
      dir: function (e, n, r) {
        for (
          var i = [], o = e[n];
          o && 9 !== o.nodeType && (r === t || 1 !== o.nodeType || !K(o).is(r));
  ...
  (Ze.optgroup = Ze.option),
        ...
        return K.access(
          ...
          function (e) {
            ...
            if (
              "string" == typeof e &&
              !Ue.test(e) &&
              (K.support.htmlSerialize || !Je.test(e)) &&
              (K.support.leadingWhitespace || !Re.test(e)) &&
              !Ze[(Ie.exec(e) || ["", ""])[1].toLowerCase()]
            ) {
              e = e.replace($e, "<$1></$2>");
              try {
                for (; r < i; r++)
      ...
      domManip: function (e, n, r) {
        ...
        if (this[0]) {
          if (
            ...
            for (
              n = n && K.nodeName(o, "tr"), s = i.cacheable || p - 1;
              l < p;
              l++
            )
              r.call(
    ...
    (K.buildFragment = function (e, n, r) {
      ...
      return (
        ...
        "undefined" == typeof n.createDocumentFragment && (n = R),
        1 === e.length &&
          "string" == typeof s &&
          s.length < 512 &&
          n === R &&
          "<" === s.charAt(0) &&
          !Ye.test(s) &&
          (K.support.checkClone || !Ge.test(s)) &&
          (K.support.html5Clone || !Je.test(s)) &&
          ((o = !0), (i = K.fragments[s]), (a = i !== t)),
        i ||
    ...
    K.extend({
      clone: function (e, t, n) {
        ...
        if (
          ...
          for (d(e, a), r = h(e), i = h(a), o = 0; r[o]; ++o)
            i[o] && d(r[o], i[o]);
        if (t && (p(e, a), n))
      ...
      clean: function (e, t, n, r) {
        var i,
          ...
          v = [];
        for (
          (t && "undefined" != typeof t.createDocumentFragment) || (t = R),
            o = t === R && et;
          null != (a = e[y]);
          y++
        )
          ...
          for (y = 0; null != (a = v[y]); y++)
            K.nodeName(a, "input")
              ...
              : "undefined" != typeof a.getElementsByTagName &&
                K.grep(a.getElementsByTagName("input"), g);
        if (n)
          for (
            h = function (e) {
            ...
            (K.nodeName(a, "script") && h(a)) ||
              (n.appendChild(a),
              "undefined" != typeof a.getElementsByTagName &&
                ((m = K.grep(K.merge([], a.getElementsByTagName("script")), h)),
  ...
  var nt,
    ...
    lt = /^margin/,
    ut = new RegExp("^(" + Z + ")(.*)$", "i"),
    ct = new RegExp("^(" + Z + ")(?!px)[a-z%]+$", "i"),
    ft = new RegExp("^([-+])=(" + Z + ")", "i"),
    pt = {},
    dt = { position: "absolute", visibility: "hidden", display: "block" },
    ht = { letterSpacing: 0, fontWeight: 400, lineHeight: 1 },
  ...
  K.fn.extend({
    ...
    K.extend({
      ...
      style: function (e, n, r, i) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
          ...
          if (
            ...
            "string" === a &&
              (o = ft.exec(r)) &&
              ((r = (o[1] + 1) * o[2] + parseFloat(K.css(e, n))),
              (a = "number")),
            !(
              null == r ||
              ("number" === a && isNaN(r)) ||
              ("number" === a && !K.cssNumber[l] && (r += "px"),
      ...
      css: function (e, n, r, i) {
        ...
        return (
          ...
          r || i !== t
            ? ((a = parseFloat(o)), r || K.isNumeric(a) ? a || 0 : o)
            : o
        );
      },
      swap: function (e, t, n) {
    ...
    K.each(["height", "width"], function (e, t) {
      K.cssHooks[t] = {
        get: function (e, n, r) {
          if (n)
            return 0 !== e.offsetWidth || "none" !== nt(e, "display")
              ? w(e, t, r)
              : K.swap(e, dt, function () {
                  return w(e, t, r);
                });
        },
        set: function (e, n, r) {
      ...
      (K.cssHooks[e + t] = {
        expand: function (n) {
          var r,
            ...
            o = {};
          for (r = 0; r < 4; r++) o[e + gt[r] + t] = i[r] || i[r - 2] || i[0];
          return o;
        },
      }),
        lt.test(e) || (K.cssHooks[e + t].set = b);
    });
  var vt = /%20/g,
    bt = /\[\]$/,
    xt = /\r?\n/g,
      ...
      return this.map(function () {
        ...
        .filter(function () {
          return (
            this.name &&
            !this.disabled &&
            (this.checked || Tt.test(this.nodeName) || wt.test(this.type))
          );
        })
        .map(function (e, t) {
          var n = K(this).val();
  ...
  (Ct = Ft.exec(Nt.toLowerCase()) || []),
    ...
    K.each(["get", "post"], function (e, n) {
      K[n] = function (e, r, i, o) {
        return (
          K.isFunction(r) && ((o = o || i), (i = r), (r = t)),
          K.ajax({ type: n, url: e, data: r, success: i, dataType: o })
        );
      };
    }),
    K.extend({
      ...
      ajax: function (e, n) {
        ...
        var i,
          ...
          T = {
            ...
            getResponseHeader: function (e) {
              ...
              if (2 === x) {
                if (!a)
                  for (a = {}; (n = kt.exec(o)); ) a[n[1].toLowerCase()] = n[2];
                n = a[e.toLowerCase()];
              }
              return n === t ? null : n;
            },
        ...
        if (
          ...
          !p.hasContent &&
            (p.data &&
              ((p.url += (Dt.test(p.url) ? "&" : "?") + p.data), delete p.data),
            (i = p.url),
            p.cache === !1))
        ) {
          var N = K.now(),
    ...
    K.ajaxPrefilter("json jsonp", function (n, r, i) {
      ...
      if ("jsonp" === n.dataTypes[0] || f || p)
        return (
          ...
          (a = e[o]),
          f
            ? (n.url = u.replace(Rt, "$1" + o))
            : p
            ? (n.data = l.replace(Rt, "$1" + o))
            : c && (n.url += (Pt.test(u) ? "&" : "?") + n.jsonp + "=" + o),
          ...
          i.always(function () {
            (e[o] = a),
              n[o] && ((n.jsonpCallback = r.jsonpCallback), Wt.push(o)),
                  ...
                  try {
                    if (r && (i || 4 === l.readyState))
                      if (
                        ((r = t),
                        a &&
                          ((l.onreadystatechange = K.noop), zt && delete It[a]),
                        i)
                      )
  ...
  (K.Animation = K.extend(F, {
    tweener: function (e, t) {
      ...
      for (var n, r = 0, i = e.length; r < i; r++)
        (n = e[r]), (Kt[n] = Kt[n] || []), Kt[n].unshift(t);
    },
    ...
    (K.fx.timer = function (e) {
      e() &&
        K.timers.push(e) &&
        !Yt &&
        (Yt = setInterval(K.fx.tick, K.fx.interval));
    }),
    (K.fx.interval = 13),
    (K.fx.stop = function () {
      ...
      position: function () {
        if (this[0]) {
          var e = this[0],
            t = this.offsetParent(),
            n = this.offset(),
            r = Zt.test(t[0].nodeName) ? { top: 0, left: 0 } : t.offset();
          return (
      ...
      offsetParent: function () {
        return this.map(function () {
          for (
            ...
            e && !Zt.test(e.nodeName) && "static" === K.css(e, "position");
