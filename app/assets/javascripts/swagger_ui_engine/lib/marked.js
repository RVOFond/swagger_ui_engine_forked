(function () {
  function e(e) {
    (this.tokens = []),
      ...
      (this.rules = p.normal),
      this.options.gfm &&
        (this.options.tables ? (this.rules = p.tables) : (this.rules = p.gfm));
  }
  function t(e, t) {
    if (
    ...
    this.options.gfm
      ? this.options.breaks
        ? (this.rules = u.breaks)
        : (this.rules = u.gfm)
      : this.options.pedantic && (this.rules = u.pedantic);
  }
  function n(e) {
    this.options = e || {};
  }
        ...
        if ((i = this.rules.escape.exec(e)))
          ...
          if ((i = this.rules.tag.exec(e)))
            !this.inLink && /^<a /i.test(i[0])
              ...
              (e = e.substring(i[0].length)),
              (l += this.options.sanitize ? s(i[0]) : i[0]);
            ...
            (e = e.substring(i[0].length)),
              (l += this.renderer.strong(this.output(i[2] || i[1])));
          else if ((i = this.rules.em.exec(e)))
            (e = e.substring(i[0].length)),
              (l += this.renderer.em(this.output(i[2] || i[1])));
          else if ((i = this.rules.code.exec(e)))
            (e = e.substring(i[0].length)),
              (l += this.renderer.codespan(s(i[2], !0)));
